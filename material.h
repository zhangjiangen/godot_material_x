#ifndef MATERIALXBAKE_MATERIAL_H
#define MATERIALXBAKE_MATERIAL_H
...
using MaterialPtr = std::shared_ptr<class MTLXMaterial>;
...
class MTLXMaterial
{
  public:
    ...
    {
        return std::make_shared<MTLXMaterial>();
    }
...
#endif // MATERIALXBAKE_MATERIAL_H
