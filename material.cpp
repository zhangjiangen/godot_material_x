...
//
// MTLXMaterial methods
//

bool MTLXMaterial::loadSource(const mx::FilePath& vertexShaderFile, const mx::FilePath& pixelShaderFile, bool hasTransparency)
{
...
void MTLXMaterial::updateUniformsList()
{
...
bool MTLXMaterial::generateShader(mx::GenContext& context)
{
    if (!_elem)
    {
        return false;
...
bool MTLXMaterial::generateShader(mx::ShaderPtr hwShader)
{
    _hwShader = hwShader;
